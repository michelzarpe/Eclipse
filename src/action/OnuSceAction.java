...
import bean.Colaborador.OnuSce;
import com.opensymphony.xwork2.ActionSupport;

@Results( { @Result(name = "resultXML", value = "xmlModel", type = XMLResult.class) })
public class OnuSceAction extends ActionSupport{
	...
	public String listAllXML() throws Exception {
		setXmlModel(OnuSce.values());
		this.totalCount = String.valueOf(OnuSce.values().length);
		return "resultXML";
	}
