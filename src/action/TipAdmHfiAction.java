...
import bean.Colaborador.TipAdmHfi;
import com.opensymphony.xwork2.ActionSupport;

@Results( { @Result(name = "resultXML", value = "xmlModel", type = XMLResult.class) })
public class TipAdmHfiAction  extends ActionSupport{
	...
	public String listAllXML() throws Exception {
		setXmlModel(TipAdmHfi.values());
		this.totalCount = String.valueOf(TipAdmHfi.values().length);
		return "resultXML";
	}
}
