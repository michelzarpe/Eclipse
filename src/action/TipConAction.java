...
import bean.Colaborador.TipCon;
import com.opensymphony.xwork2.ActionSupport;

@Results( { @Result(name = "resultXML", value = "xmlModel", type = XMLResult.class) })
public class TipConAction extends ActionSupport{
	...
	public String listAllXML() throws Exception {
		setXmlModel(TipCon.values());
		this.totalCount = String.valueOf(TipCon.values().length);
		return "resultXML";
	}
