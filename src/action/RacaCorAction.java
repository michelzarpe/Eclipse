...
import bean.Colaborador.RacaCor;

import com.opensymphony.xwork2.ActionSupport;

@Results( { @Result(name = "resultXML", value = "xmlModel", type = XMLResult.class) })
public class RacaCorAction  extends ActionSupport{
	...
	public String listAllXML() throws Exception {
		setXmlModel(RacaCor.values());
		this.totalCount = String.valueOf(RacaCor.values().length);
		return "resultXML";
	}
}
