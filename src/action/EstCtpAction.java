...
import bean.Colaborador.EstCtp;
import com.opensymphony.xwork2.ActionSupport;

@Results( { @Result(name = "resultXML", value = "xmlModel", type = XMLResult.class) })
public class EstCtpAction  extends ActionSupport{
	...
	public String listAllXML() throws Exception {
		setXmlModel(EstCtp.values());
		this.totalCount = String.valueOf(EstCtp.values().length);
		return "resultXML";
	}
}