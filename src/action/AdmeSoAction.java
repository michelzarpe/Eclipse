...
import bean.Colaborador.AdmeSo;
import com.opensymphony.xwork2.ActionSupport;

@Results( { @Result(name = "resultXML", value = "xmlModel", type = XMLResult.class) })
public class AdmeSoAction  extends ActionSupport{
	...
	public String listAllXML() throws Exception {
		setXmlModel(AdmeSo.values());
		this.totalCount = String.valueOf(AdmeSo.values().length);
		return "resultXML";
	}
}
