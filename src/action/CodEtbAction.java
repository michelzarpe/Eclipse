...
import bean.Colaborador.CodEtb;
import com.opensymphony.xwork2.ActionSupport;

@Results( { @Result(name = "resultXML", value = "xmlModel", type = XMLResult.class) })
public class CodEtbAction  extends ActionSupport{
	...
	public String listAllXML() throws Exception {
		setXmlModel(CodEtb.values());
		this.totalCount = String.valueOf(CodEtb.values().length);
		return "resultXML";
	}
}
