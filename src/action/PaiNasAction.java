...
public class PaiNasAction  extends ActionSupport{
	...
	public String listAllXML() throws Exception {
		setXmlModel(PaiNas.values());
		this.totalCount = String.valueOf(PaiNas.values().length);
		return "resultXML";
	}
}
